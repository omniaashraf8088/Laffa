...
class RideHistoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          isArabic ? AppStringsAr.rideHistory : AppStringsEn.rideHistory,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            isArabic ? AppStringsAr.noRidesYet : AppStringsEn.noRidesYet,
            style: AppTextStyles.title(
              isArabic: isArabic,
          ...
          Text(
            isArabic ? AppStringsAr.scanQrToStart : AppStringsEn.scanQrToStart,
  ...
  Widget _buildRideCard(RideHistoryItem ride, bool isArabic) {
    ...
    final statusLabel = isCompleted
        ...
        : (isArabic ? AppStringsAr.cancelled : AppStringsEn.cancelled);
