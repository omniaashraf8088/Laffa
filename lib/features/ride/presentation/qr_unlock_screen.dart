          ...
          child: Row(
            children: [
              ...
              Text(
                ...
                style: AppFonts.title(isArabic: isArabic, color: Colors.white),
              ),
              const Spacer(),
              _buildCircleButton(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                isArabic ? 'جاري فتح السكوتر...' : 'Unlocking scooter...',
                style: AppFonts.style(
                  isArabic: isArabic,
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              isArabic ? 'تم فتح السكوتر!' : 'Scooter Unlocked!',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  isArabic ? 'ابدأ الرحلة' : 'Start Ride',
  ...
  void _showManualEntry(BuildContext context, bool isArabic) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          isArabic ? 'أدخل رمز السكوتر' : 'Enter Scooter Code',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(isArabic ? 'فتح' : 'Unlock'),
          ),
        ],
      ),
    );
