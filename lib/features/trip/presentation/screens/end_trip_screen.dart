        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                isArabic ? AppStringsAr.noTripData : AppStringsEn.noTripData,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      isArabic
                          ? AppStringsAr.tripCompleted
                          : AppStringsEn.tripCompleted,
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                  context.go('${AppRouter.rating}?tripId=${trip.id}');
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.primary,
                  foregroundColor: AppColors.white,
                ...
                label: Text(
                  isArabic
                      ? AppStringsAr.rateThisTrip
                      : AppStringsEn.rateThisTrip,
