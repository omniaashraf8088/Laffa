...
class _StartTripScreenState extends ConsumerState<StartTripScreen>
  ...
  Widget _buildSafetyTips(bool isArabic) {
    final tips = isArabic
        ? ['ارتدِ خوذة الأمان', 'احترم قواعد المرور', 'استخدم مسارات الدراجات']
        : [
      ...
      child: SafeArea(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: Text(
              tripState.isEnding
                  ? (isArabic ? 'جاري الإنهاء...' : 'Ending...')
                  : (isArabic ? 'إنهاء الرحلة' : 'End Trip'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            isArabic ? 'جاري فتح الدراجة...' : 'Unlocking your bike...',
