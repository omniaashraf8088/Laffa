...
import '../controllers/booking_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<BookingState>(bookingProvider, (previous, next) {
      if (next.currentBooking != null &&
          ...
          !next.isLoading) {
        context.push(
          '${AppRouter.payment}?bookingId=${next.currentBooking!.id}'
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          isArabic ? AppStringsAr.bookABike : AppStringsEn.bookABike,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isArabic
                      ? AppStringsAr.availableBikes
                      : AppStringsEn.availableBikes,
                  style: AppTextStyles.title(
                    isArabic: isArabic,
      ...
      child: Center(
        child: Column(
          children: [
            ...
            Text(
              isArabic
                  ? AppStringsAr.noBikesAvailable
                  : AppStringsEn.noBikesAvailable,
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(isArabic ? AppStringsAr.retry : AppStringsEn.retry),
            ),
          ],
        ),
      ),
