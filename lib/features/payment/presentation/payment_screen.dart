        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: state.isProcessing
                ...
                : Text(
                    isArabic
                        ? 'ادفع ${widget.amount.toStringAsFixed(1)} EGP'
                        : 'Pay ${widget.amount.toStringAsFixed(1)} EGP',
                    style: AppFonts.button(
                      isArabic: isArabic,
                      color: AppColors.white,
                    ),
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                isArabic
                    ? 'يمكنك بدء رحلتك الآن'
                    : 'You can start your trip now',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    isArabic ? 'ابدأ الرحلة' : 'Start Trip',
                    style: AppFonts.button(
                      isArabic: isArabic,
                      color: AppColors.white,
                    ),
