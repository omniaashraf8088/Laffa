...
class PasswordStrengthIndicator extends StatelessWidget {
  ...
  String _getStrengthLabel() {
    ...
    if (strength == 0) {
      return isArabic ? AppStringsAr.tooWeak : AppStringsEn.tooWeak;
    }
    if (strength == 1) {
      return isArabic ? AppStringsAr.weak : AppStringsEn.weak;
    }
    if (strength == 2) {
      return isArabic ? AppStringsAr.medium : AppStringsEn.medium;
    }
    return isArabic ? AppStringsAr.strong : AppStringsEn.strong;
  }
}
