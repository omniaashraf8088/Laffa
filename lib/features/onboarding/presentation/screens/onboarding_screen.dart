...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen>
  ...
  // â”€â”€ Parallax floating shapes â”€â”€
    ...
    return Positioned(
      ...
      child: SafeArea(
        child: AnimatedOpacity(
          opacity: _currentPage == onboardingPages.length - 1 ? 0.0 : 1.0,
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    isArabic ? AppStringsAr.skip : AppStringsEn.skip,
  ...
  // â”€â”€ Bottom navigation panel â”€â”€
  ...
  // â”€â”€ Indicators with animated active dot â”€â”€
        ...
        if (_currentPage > 0 && !isLastPage)
          Expanded(
            child: _AnimatedBackButton(
              label: isArabic ? AppStringsAr.back : AppStringsEn.back,
              isArabic: isArabic,
              onPressed: () {
          ...
          child: AnimatedSwitcher(
            ...
            child: isLastPage
                ...
                : _NextButton(
                    ...
                    label: isArabic ? AppStringsAr.next : AppStringsEn.next,
                    isArabic: isArabic,
...
// â”€â”€ Next button with progress ring â”€â”€
...
// â”€â”€ Get Started button with gradient + shine â”€â”€
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        widget.label,
                        style: AppTextStyles.authSecondaryTitle(
